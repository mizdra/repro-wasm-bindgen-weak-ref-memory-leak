...
function __wbg_adapter_29(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h53fdc09f7b7e91ea(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}

const MyBufferFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mybuffer_free(ptr >>> 0));
/**
*/
class MyBuffer {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(MyBuffer.prototype);
        obj.__wbg_ptr = ptr;
        MyBufferFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MyBufferFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mybuffer_free(ptr);
    }
    /**
    * @param {number} size
    ...
    */
    static new(size) {
        const ret = wasm.mybuffer_new(size);
    ...
    */
    get_data() {
        try {
            ...
            wasm.mybuffer_get_data(retptr, this.__wbg_ptr);
...
module.exports.MyBuffer = MyBuffer;

module.exports.__wbg_mybuffer_new = function(arg0) {
    const ret = MyBuffer.__wrap(arg0);
...
const path = require('path').join(__dirname, 'my-buffer_bg.wasm');
