...
$ node --expose-gc --wasm-max-mem-pages=3000 sync.mjs
...
RuntimeError: unreachable
    ...
    at file:///Users/mizdra/src/github.com/mizdra/repro-wasm-bindgen-weak-ref-memory-leak/sync.mjs:6:15
...
$ node --expose-gc --wasm-max-mem-pages=3000 async.mjs
```
